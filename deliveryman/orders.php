                  ...
                  <table class="table table-hover tablesorter " id="">
                    ...
                    <tbody>
                      <?php 
                        ...
                        <td>
                            <a class=' btn btn-safe' href='orders.php?order_id=$order_id&action=delete'>Accept</a>
                        <a class=' btn btn-danger' href='orders.php?order_id=$order_id&action=delete'>Reject</a>
                        </td></tr>";
                        }
                        ?>
                    </tbody>

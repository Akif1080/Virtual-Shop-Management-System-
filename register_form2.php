						...
						<!-- /Billing Details -->
								...
								<form id="signup_form" onsubmit="return false" class="login100-form">
                                    ...
                                    <div class="section-title">
                                        <h2 class="login100-form-title p-b-49" >Seller Registration</h2>
                                    </div>
                                    
<div class="form-group">
    <input class="input form-control input-borders" type="text" name="store_name" id="store_name" placeholder="Store Name">
</div>
